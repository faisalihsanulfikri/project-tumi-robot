      ...
      return new Promise((resolve, reject) => {
        ...
        for (let index = 0; index < row.length; index++) {
          ...
          for (let i = 0; i < row[index].cells.length; i++) {
            result["time"] = row[index].cells[1].textContent
            result["order"] = row[index].cells[2].textContent
            result["market"] = row[index].cells[3].textContent
            result["action"] = row[index].cells[4].textContent
            result["stock"] = row[index].cells[5].textContent
            result["price"] = row[index].cells[7].textContent
            result["remain"] = row[index].cells[8].textContent
            result["match"] = row[index].cells[9].textContent
